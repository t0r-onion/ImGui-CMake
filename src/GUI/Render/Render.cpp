...
ID3D11Device* Render::pd3dDevice = nullptr;
ID3D11DeviceContext* Render::pd3dDeviceContext = nullptr;
IDXGISwapChain* Render::pSwapChain = nullptr;
ID3D11RenderTargetView* Render::pMainRenderTargetView = nullptr;

HMODULE Render::hCurrentModule = nullptr;
...
void Render::Init()
{
    ...
    const WNDCLASSEX wc = { sizeof(WNDCLASSEX), CS_CLASSDC, WndProc, 0L, 0L, GetModuleHandle(nullptr), nullptr, nullptr, nullptr, nullptr, _T("ImGui + CMake"), nullptr };
    ::RegisterClassEx(&wc);
    const HWND hwnd = ::CreateWindow(wc.lpszClassName, _T("ImGui + CMake"), WS_OVERLAPPEDWINDOW, 100, 100, 50, 50, NULL, NULL, wc.hInstance, NULL);
